...
int main ()
{
    ...
    xcb_create_window(connection,                    /* X Server connection   */
    ...
    // I think this just make us wait until all the pending requests are finished?
    ...
    printf("Program Finished. Press Ctrl-C to exit...");
    pause();
